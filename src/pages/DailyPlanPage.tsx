...
const dailyPlans = [
  {
    ...
    meals: [
      { time: "Colazione", description: "Frullato Herbalife + 1 frutto (prima delle 10:00)", icon: Coffee },
  ...
  },
  {
    ...
    meals: [
      { time: "Colazione", description: "Frullato Herbalife + 1 mela (prima delle 10:00)", icon: Coffee },
  ...
  // Days 3-10 would follow the same pattern
  {
    ...
    meals: [
      { time: "Colazione", description: "Frullato Herbalife + 1 kiwi (prima delle 10:00)", icon: Coffee },
  ...
  // Continue with days 4-10...
  {
    ...
    meals: [
      { time: "Colazione", description: "Frullato Herbalife + fragole (prima delle 10:00)", icon: Coffee },
  ...
  },
  {
    ...
    meals: [
      { time: "Colazione", description: "Frullato Herbalife + 1/2 banana (prima delle 10:00)", icon: Coffee },
  ...
  // Days 6-10...
  {
    ...
    meals: [
      { time: "Colazione", description: "Frullato Herbalife + mirtilli (prima delle 10:00)", icon: Coffee },
  ...
  },
  {
    ...
    meals: [
      { time: "Colazione", description: "Frullato Herbalife + pere (prima delle 10:00)", icon: Coffee },
  ...
  },
  {
    ...
    meals: [
      { time: "Colazione", description: "Frullato Herbalife + arancia (prima delle 10:00)", icon: Coffee },
  ...
  },
  {
    ...
    meals: [
      { time: "Colazione", description: "Frullato Herbalife + kiwi (prima delle 10:00)", icon: Coffee },
  ...
  },
  {
    ...
    meals: [
      { time: "Colazione", description: "Frullato Herbalife + mix di frutti di bosco (prima delle 10:00)", icon: Coffee },
