...
const dailyPlans = [
  {
    ...
    meals: [
      ...
      { time: "Spuntino", description: "Snack Herbalife (barrette o patatine) - Snack come frutta secca uova e quelli che trovi nella lista consigliata. Puoi farti anche un frullato in più", icon: Coffee },
      ...
      { time: "Merenda", description: "Snack Herbalife (barrette o patatine) - Snack come frutta secca uova e quelli che trovi nella lista consigliata. Puoi farti anche un frullato in più", icon: Coffee },
